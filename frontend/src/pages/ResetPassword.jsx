    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-zvote-900 to-zvote-700 px-4">
        <div className="w-full max-w-sm bg-white rounded-xl shadow-md p-8 text-center space-y-4">
          ...
          <p className="text-sm text-slate-500">The password reset link is missing required parameters.</p>
          <Link to="/login" className="inline-block text-sm text-zvote-600 hover:underline">
            Back to Sign In
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-zvote-900 to-zvote-700 px-4">
      <form onSubmit={handleSubmit} className="w-full max-w-sm bg-white rounded-xl shadow-md p-8 space-y-5">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Set a new secure password for your account.</p>
        </div>
